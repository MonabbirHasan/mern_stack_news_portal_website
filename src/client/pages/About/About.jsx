                        ...
                        <div id='wrape_section'>
                            ...
                            <div className='founder_box'>
                                <div className="founder_info">
                                    <Row>
                                        <Col lg={3}><div className="founder_one">
                                            <img title='founder and CEO' src={touhid} className='img-fluid owner_img' id="company_about_page_logo" alt="touhidul islam" />
                                            <h3 className='founder_name'>SM Touhidul Islam</h3>
                                            <h4 className='designation'>founder and CEO</h4>
                                        </div>
                                        </Col>
                                        <Col lg={6}><div className="my-sm-3 middle_image">
                                            <img title='Co-founder and CTO' src={company_logo} className='img-fluid' alt="Monabbir Hasan" />
                                        </div>
                                        </Col>
                                        <Col lg={3}><div className="founder_tow">
                                            <img title='Co-founder and CTO' src={monabbirhasan} className='img-fluid owner_img' alt="Monabbir Hasan" />
