  ...
  return (
    <div className='post_card'>
      ...
      <div className="post_info">
        ...
        <span><CalendarMonth htmlColor='#444' fontSize='small' /><small>{props.published}</small></span>
        <span><Comment htmlColor='#444' fontSize='small' /><small>{props.comment}</small></span>
      </div>
