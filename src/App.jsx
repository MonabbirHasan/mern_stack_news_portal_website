...
const WebsiteTemplate = lazy(() => import("./client/pages/website_template/WebsiteTemplate"))
const AdminTmpDetails = lazy(() => import("./client/pages/admin_tmp_details/AdminTmpDetails"))
const ServiceReques = lazy(() => import("./client/pages/service_request/ServiceReques"))
const AdminTemplate = lazy(() => import("./client/pages/admin_template/AdminTemplate"))
        ...
        <Suspense fallback={() => <h1>Loading...</h1>}>
          <Router>
            <Routes>
              ...
              <Route path="/admin_template/:slug" element={<AdminTmpDetails />} />
